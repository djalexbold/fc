...
const API_URL = import.meta.env.LMSTUDIO_API_URL || "http://192.168.0.4:1234/v1/chat/completions";
const API_KEY = import.meta.env.LMSTUDIO_API_KEY || "";
...
export async function fetchModels() {
  try {
    const res = await axios.get("http://192.168.0.4:1234/v1/models");
