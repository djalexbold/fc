...
<template>
    <div class="space-y-6">
        <HeadingSmall title="Удалить аккаунт" description="Удалите свой аккаунт и все его ресурсы." />
        <div class="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
            <div class="relative space-y-0.5 text-red-600 dark:text-red-100">
                <p class="font-medium">Внимание</p>
                <p class="text-sm">Просим проявлять крайнюю осторожность: данные действия необратимы</p>
            </div>
            <Dialog>
                ...
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                              После удаления вашей учетной записи все ее ресурсы и данные также будут безвозвратно удалены.
